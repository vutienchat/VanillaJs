            ...
            <div class="shadow p-8 w-4/5 md:w-1/2 lg:w-2/6">
                <form id="form-SignUp">
                    ...
                    <div class="relative mb-4 form__item ">
                        <input type="text" name="" required class=" cursor-pointer pt-3 pb-2 px-2 w-full focus:outline-none " id="userName">
                        <label  class="absolute left-0 top-1/2 pointer-events-none transform -translate-y-2/4 w-full h-full  border-b-2 ">
                            <span class="text-sm text-gray-400 absolute left-0 top-1/2 transform -translate-y-2/4 content-lable">UserName</span>
                        </label>
                    </div>
                    <div class="relative mb-4 form__item ">
                    ...
                    <button class="focus:outline-none text-white text-sm py-2 px-16 rounded-md bg-blue-500 hover:bg-blue-600 hover:shadow-lg text-lg">Sign Up</button>
                    </div>
                </form>
            </div>
        </div>
